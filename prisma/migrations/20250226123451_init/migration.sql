...
CREATE TABLE "Spreadsheet" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "data" JSONB NOT NULL DEFAULT '{"cells":{},"rowCount":100,"columnCount":26}',
    "userId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Share_spreadsheetId_userId_key" ON "Share"("spreadsheetId", "userId");
...
-- AddForeignKey
ALTER TABLE "Share" ADD CONSTRAINT "Share_spreadsheetId_fkey" FOREIGN KEY ("spreadsheetId") REFERENCES "Spreadsheet"("id") ON DELETE CASCADE ON UPDATE CASCADE;
